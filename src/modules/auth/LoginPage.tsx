      ...
      <div className="relative grid w-full max-w-6xl grid-cols-1 gap-6 lg:grid-cols-[1fr_430px]">
        ...
        <div className="rounded-[2rem] border border-slate-100 bg-white p-8 shadow-2xl">
          ...
          <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); submit(); }}>
            ...
            <div><label className="label">كلمة المرور</label><input className="input" type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="كلمة المرور" /></div>
